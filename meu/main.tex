...
Aqui, será apresentado os papéis criados pela equipe e as árvores de comportamento criadas para cada um deles.
...
O auxiliar, por sua vez, tem uma Behavior Tree muito simples, representada por apenas um nó que tem como função se posicionar em lugar ótimo com Triangulação de Delaunay\cite{delaunay34}. Sua árvore, é representada simplesmente por \ref{fig:auxiliar_bt}.
...
\subsubsection{Um principal e um auxiliar}

\subsubsection{Troca de goleiro}

...
O robô foi projetado com duas rodas laterais e duas esferas livres à frente e atrás para manter o equilíbrio. Essa característica o torna um robô diferencial. Ou seja, temos o controle sobre as velocidades linear e angular, mas não é possível mover o robô para os lados.
...
\textbf{Selector Behavior} Nesse behavior, é selecionado um de seus filhos para ser acessado. Ele é usado quando tem-se várias maneiras de se realizar uma mesma ação e deve-se escolher uma delas.

\textbf{Sequence Behavior} São nós que apenas retornam um estado sem realizar nenhuma ação concreta, como checar se o time está atacando.

\textbf{Parallel Behavior} São nós que apenas retornam um estado sem realizar nenhuma ação concreta, como checar se o time está atacando.

\textbf{Decorator} São nós que apenas retornam um estado sem realizar nenhuma ação concreta, como checar se o time está atacando.

...
\item Com a posição obtida pela triangulação, é usado o algoritmo de planejamento de trajetórias, em conjunto com o seu controlador, para chegar nessa posição interpolada.

...
\begin{document}
    ...
    \subsection{Corpo do Texto}
        ...
        Os símbolos usados nas equações devem ser definidos imediatamente antes ou depois de sua primeira ocorrência no texto. \citep{bellingham2002}
        ...
        A citação das referências no corpo do texto pode ser feita nos formatos: "\citet{bellingham2002} mostra que o corpo...", ou: "Vários trabalhos (\citeauthor{bellingham2002}, \citeyear{bellingham2002}; \citeauthor{bellingham2002}, \citeyear{bellingham2002} e \citeauthor{bellingham2002},  \citeyear{bellingham2002}) mostram que a rigidez...".

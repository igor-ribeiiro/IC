...
Nessa secção, será apresentado os resultados obtidos ao executar o algoritmo de otimização CMA-ES com as funções de custo apresentadas anteriormente. Será mostrado e comentado como foi a convergência geral do algoritmo e de cada parâmetro em cada caso.
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.8\textwidth]{figures/CMA-ES_Fitness_Results.png}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.8\textwidth]{figures/CMA-ES_Total_parameter_convergence.png}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.8\textwidth]{figures/CMA-ES_Fitness_Results_ally.png}
	\caption{Fitness Cost em função do número de iterações}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.8\textwidth]{figures/CMA-ES_Total_parameter_convergence_ally.png}
	\caption{Convergência total dos parâmetros em função do número de iterações}

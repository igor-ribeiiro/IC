...
Na Figura \ref{fig:univector}, é possível observar, em um determinado instante, as trajetórias calculadas para cada jogador, representado pelos círculos grandes coloridos, e os vetores do campo do Univector Field para o jogador verde. As trajetórias do Univector para cada jogador podem ser vistas em verde e saem do jogador até o seu ponto de destino.
...
Nessa secção será apresentado os resultados obtidos para as trajetória antes e depois da otimização realizada. As Figuras foram obtidas usando a ferramenta de depuração da equipe, conforme a Figura \ref{fig:univector}.
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.75\textwidth]{figures/ruim_trajetoria.png}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.75\textwidth]{figures/bom_trajetoria.png}
